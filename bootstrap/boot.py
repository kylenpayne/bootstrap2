...
This should improve the computational efficiency of any methods that
use these, including sample().
...
class Bootstrap(Statistic):
    ...
    ## the jit decorator tells Numba to compile this function for
    ## faster performance.
    # @jit
